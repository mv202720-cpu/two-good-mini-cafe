const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-Zhm4fLBM.js","assets/proxy-bYZ_owAr.js","assets/chevron-right-Be4RGCaQ.js","assets/Menu-D3vEl9l8.js","assets/index-DqgVw44B.js","assets/Contact-C6HHKvRx.js","assets/Cart-BRUTjlWE.js","assets/separator-D0G49_4l.js","assets/Checkout-uLqA9znQ.js"])))=>i.map(i=>d[i]);
...
const WA_URL$1 = "https://wa.me/919958658589?text=Hi%2C%20I%20want%20to%20place%20an%20order!";
const hostname = encodeURIComponent(
  typeof window !== "undefined" ? window.location.hostname : "twogoodcafe"
);
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-[oklch(0.10_0_0)] border-t border-white/8 text-white/70", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:col-span-2 lg:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display font-bold text-lg text-white mb-2", children: [
          "Two Good ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-orange", children: "Mini Café" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed mb-4", children: "Bold flavours, honest prices — your everyday street café in the heart of Delhi." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-semibold text-sm mb-4 uppercase tracking-wider", children: "Quick Links" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-semibold text-sm mb-4 uppercase tracking-wider", children: "Find Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Block E, Khazoori Khas, Delhi 110090" })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "10 AM – 11 PM, All Days" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-semibold text-sm mb-4 uppercase tracking-wider", children: "Order Now" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: WA_URL$1,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-xs text-white/40", children: "Fastest way to order — we reply in minutes!" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 pt-6 border-t border-white/8 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/35", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Two Good Mini Café. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
...
function isSameItem(item, id, priceIndex) {
  ...
  switch (action.type) {
    ...
    case "ADD_ITEM": {
      const existing = state.items.find(
        (i) => isSameItem(i, action.menuItem.id, action.priceIndex)
      );
      if (existing) {
        return {
          items: state.items.map(
            (i) => isSameItem(i, action.menuItem.id, action.priceIndex) ? { ...i, quantity: i.quantity + 1 } : i
          )
        };
      }
      return {
    ...
    case "UPDATE_QUANTITY": {
      ...
      return {
        items: state.items.map(
          (i) => isSameItem(i, action.id, action.priceIndex) ? { ...i, quantity: action.qty } : i
        )
      };
    }
    case "CLEAR_CART":
...
function CartProvider({ children }) {
  const [state, dispatch] = reactExports.useReducer(cartReducer, { items: [] });
  reactExports.useEffect(() => {
  ...
  const cartTotal = state.items.reduce(
    (sum, i) => sum + i.menuItem.prices[i.selectedPriceIndex].amount * i.quantity,
    0
  );
  const value = {
    cartItems: state.items,
    addToCart: (menuItem, priceIndex) => dispatch({ type: "ADD_ITEM", menuItem, priceIndex }),
    removeFromCart: (id, priceIndex) => dispatch({ type: "REMOVE_ITEM", id, priceIndex }),
    updateQuantity: (id, priceIndex, qty) => dispatch({ type: "UPDATE_QUANTITY", id, priceIndex, qty }),
...
const WA_HREF = "https://wa.me/919958658589?text=Hi%2C%20I%20want%20to%20order!";
const links = [
  { label: "Home", href: "/" },
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      "data-ocid": "navbar",
      className: `fixed top-0 inset-x-0 z-40 transition-smooth ${scrolled || mobileOpen ? "glass-dark shadow-elevated" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex h-16 items-center justify-between px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-8 w-8 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-glow-orange", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UtensilsCrossed, { className: "h-4 w-4" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-white leading-tight text-[15px] sm:text-base", children: [
                  "Two Good ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-orange", children: "Mini Café" })
                ] })
              ]
              ...
              children: [
                links.map((link) => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Link,
                    {
                      ...
                      className: `relative px-4 py-2 text-sm font-medium rounded-lg transition-smooth ${active ? "text-primary" : "text-white/80 hover:text-white hover:bg-white/10"}`,
                      children: [
                        link.label,
                        active && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 h-0.5 w-5 rounded-full bg-primary" })
                      ]
                    },
                    link.href
                  );
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Link,
                  {
                    ...
                    className: `relative ml-1 p-2 rounded-lg transition-smooth ${pathname === "/cart" ? "text-primary" : "text-white/80 hover:text-white hover:bg-white/10"}`,
                    children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                "aria-label": `Cart${cartCount > 0 ? `, ${cartCount} items` : ""}`,
                className: `relative p-2 rounded-lg transition-smooth ${pathname === "/cart" ? "text-primary" : "text-white/80 hover:text-white hover:bg-white/10"}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "h-5 w-5" }),
                  cartCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
              ...
              links.map((link) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    ...
                    className: `px-4 py-3 rounded-xl text-sm font-medium transition-smooth ${active ? "bg-primary/15 text-primary" : "text-white/80 hover:text-white hover:bg-white/10"}`,
                    children: link.label
                  },
                  link.href
                );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Order Now" })
      ]
    }
  );
}
function Layout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-[oklch(0.10_0_0)] text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 page-enter", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(WhatsAppFloat, {})
  ] });
}
const HomePage = reactExports.lazy(() => __vitePreload(() => import("./Home-Zhm4fLBM.js"), true ? __vite__mapDeps([0,1,2]) : void 0));
const MenuPage = reactExports.lazy(() => __vitePreload(() => import("./Menu-D3vEl9l8.js"), true ? __vite__mapDeps([3,1,4]) : void 0));
const ContactPage = reactExports.lazy(() => __vitePreload(() => import("./Contact-C6HHKvRx.js"), true ? __vite__mapDeps([5,1]) : void 0));
const CartPage = reactExports.lazy(() => __vitePreload(() => import("./Cart-BRUTjlWE.js"), true ? __vite__mapDeps([6,7,1,4]) : void 0));
const CheckoutPage = reactExports.lazy(() => __vitePreload(() => import("./Checkout-uLqA9znQ.js"), true ? __vite__mapDeps([8,7,2,4,1]) : void 0));
function PageFallback() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-24 space-y-4", children: [
...
const homeRoute = createRoute({
  ...
  path: "/",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, {}) })
});
const menuRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/menu",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(MenuPage, {}) })
});
const contactRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/contact",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContactPage, {}) })
});
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CartProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { router }) });
}
